	...
	<script src="assets/js/form_cadastro.js"></script>
		...
		<!-- Footer -->
			<footer id="footer_login">
				<div class="inner">
						<div>
							<span class="icon fa-eye fa-2x"></span>
							<h3>Redefina sua senha agora mesmo</h3>
						</div>
					

					<form name="form_login" action="DAO/senha.php" method="post">
						...
						<div class="field half first">
							...
							<input name="email" id="email" type="email" placeholder="email@dominio.com" required="true">
						</div>
						
						<ul class="actions">	<br>
							<li><input value="Redefinir" class="button alt" type="submit"></li>
						</ul>
						
                    </form>
                    <div class="copyright">
						*Entre em contato com sac@intime.com.br para maiores duvidas</div> <br><br>
					<div class="copyright">
