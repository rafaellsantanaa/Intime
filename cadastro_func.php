	...
	<script src="assets/js/form_cadastro.js"></script>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="inner">
						<div>
							<span class="icon fa-plug fa-2x"></span>
							<h3>Junte-se a sua equipe agora mesmo</h3>
						</div>

					<form name="form_cad_func" action="DAO/CADASTRO/cad_func.php" method="post">
						...
						<div class="field half first">
							...
							<input name="cpf" id="cpf" type="text" onBlur="validarCPF(form_cad_func.cpf);" onKeyPress="mascaraCPF(form_cad_func.cpf);"  
							 placeholder="000.000.000-00" maxlength="14" required="true">
						</div>
						<div class="field half">
							<label for="dt_nascimento">Data de Nascimento</label>
							<input name="dt_nascimento" id="dt_nascimento" onBlur="validaData(form_cad_func.dt_nascimento);" type="text" placeholder="dd/mm/aaaa" onKeyUp="mascaraData(form_cad_func.dt_nascimento);" maxlength="10" required="true">
						</div>
						<div class="field half">
							<label for="cargo">Cargo</label>
							<input name="cargo" id="cargo" type="text" placeholder="Ex: Analista de Sistemas Jr" required="true">
						</div> <br>
						<div class="field half">
