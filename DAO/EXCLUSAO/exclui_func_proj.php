...
$db = mysqli_select_db($connect,'intime');
    ...
    $query_select = ("update `projeto_funcionario` set ativo=0
                        where id_projeto = '$id_projeto' and cpf='$cpf'");
    mysqli_query($connect,$query_select);
    echo $query_select;
    if ($_SESSION['func']==1){
        echo"<script language='javascript' type='text/javascript'>
        alert('Funcionário excluido com sucesso :D');window.location.href='../../painel_func.php';</script>";

    }else if ($_SESSION['func']==0){
        echo"<script language='javascript' type='text/javascript'>
        alert('Funcionário excluido com sucesso :D');window.location.href='../../painel_gest.php';</script>";
    }
